...
function TecnoclifeView() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-4 md:p-8 lg:p-10 animate-in fade-in duration-700">
      {/* Header Corporativo - DISEÑO MINIMALISTA Y PROFESIONAL */}
        ...
        <div className="xl:col-span-4">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-32 bg-white rounded-[60px] border border-dashed border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-black text-slate-800">No se hallaron equipos</p>
              <p className="text-slate-400 mt-2 font-medium">Ajusta los filtros para ver más resultados de Tecnoclife.</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="px-8 pb-8 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                        <div>
                          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5 italic">Stock Price</p>
