      ...
      <header className="max-w-[1600px] mx-auto mb-8 md:mb-12 flex flex-row items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
            eBay <span className="text-[#00e5a0] drop-shadow-[0_0_30px_rgba(0,229,160,0.3)]">Deals</span>
          </h1>
        </div>
        ...
        <div className="flex items-center gap-3 bg-white p-1.5 pl-3 sm:pl-5 rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm">
          <div className="flex flex-col">
            <span className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Listados Activos</span>
            <p className="text-base sm:text-lg font-black text-slate-700 leading-none">{productosFiltrados.length}</p>
          </div>
          <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl sm:rounded-2xl bg-[#00e5a0]/20 flex items-center justify-center text-[#00e5a0] font-bold">
            ...
            <div className={`p-6 xl:p-8 pt-2 xl:pt-0 space-y-8 ${mostrarFiltrosMobi ? 'block' : 'hidden xl:block'}`}>
              ...
              <div>
                <div className="flex justify-between items-end mb-3">
                  <label className="text-[10px] sm:text-[11px] font-bold uppercase text-slate-500 tracking-widest">Presupuesto (USD)</label>
        ...
        <div className="xl:col-span-4">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 md:py-32 bg-white rounded-3xl xl:rounded-[60px] border border-dashed border-slate-200 px-4 text-center">
              ...
              <p className="text-sm text-slate-400 mt-1 font-medium">Prueba ajustando el rango de precio o el término.</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="p-5 sm:p-6 xl:p-8 pt-0 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
                        <div>
                          <p className="text-[9px] font-black text-[#00e5a0] uppercase tracking-widest mb-0.5">Precio hoy</p>
