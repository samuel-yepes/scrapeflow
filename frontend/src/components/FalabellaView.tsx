            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="flex justify-between mt-3">
                  ...
                  <span className="text-sm font-bold text-slate-700">${filtroPrecio.toLocaleString("es-CO")}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="xl:col-span-4">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-32 bg-white rounded-[60px] border border-dashed border-slate-200 shadow-sm">
              ...
              <p className="text-slate-400 mt-2 font-medium">Prueba con otros filtros o términos.</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="relative h-60 p-10 flex items-center justify-center">
                      ...
                      <img
                        ...
                        onError={(e) => (e.currentTarget.src = "https://via.placeholder.com/400x300?text=PC")}
                      />
                    </div>
                    ...
                    <div className="px-8 pb-8 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                        <div>
                          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Precio Hoy</p>
...
// Subcomponente de Especificación más limpio
